...
public class ZTE_CDN_LOG_SENDEMAIL_PIC_DNS {
	...
	public static void main(String[] args) throws Exception {
		...
		String emailSubject = getProperties.getPropertie("emailSubject_dns").trim();
	   ...
	   email.setTo( getProperties.getPropertie("receiverAddr_dns").trim());
		...
		for (int i=0;i<PAGE.length;i++){
			...
			page_path = page_path+ pic_paht+PAGE[i]+"_"+ip+"_"+yesterday+".png";
