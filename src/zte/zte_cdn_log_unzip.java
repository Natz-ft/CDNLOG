...
public class zte_cdn_log_unzip {
	  ...
	  public static final int BUFFER = 1024;  
		...
		public static boolean  decompressSingleFile(String path, String fileName) {
			...
			try {
					...
					cdnSetLog.setlog("cdn_zte_log_unzip", fileName,path.replace("\\", "\\\\")); // д���ݿ���־
		 ...
		 public static void decompress() throws Exception { // ͨ����־���ѹ���ļ����н�ѹ���� 
				...
				while (db.next()) {
					...
					{
						cdnSetLog.updateStatus("cdn_zte_log_sftp", fileName,"ERROR");
					}
					;
				}
					db.closeRs();
    ...
    * */
	public static List<List<String[]>> getThreadFileList() {
		...
		String sql = "select localpath,fileName from cdn_zte_log_sftp where status is null or status = ''    ";
    ...
    public static void main(String[] args) throws Exception { 
    	decompressSingleFile("F:\\ftp\\20181106\\s","BCS-CDN-024-AS0201_OTTCACHE_20181106T052001Z.tar.gz");  	
